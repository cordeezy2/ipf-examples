...
class IPFDoraExample(IPFExtension):
    ...
    def input_form(self):
        ...
        if not ipf_client:
            ...
            return
        self.st.write("Upload a valid toml file. The Toml represents the configuration of the Dora Application path and the intent checks to be performed.")
